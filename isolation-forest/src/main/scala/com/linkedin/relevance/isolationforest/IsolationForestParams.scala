...
trait IsolationForestParams extends Params {
  ...
  final val contaminationError = new DoubleParam(
    this,
    "contaminationError",
    "The error" +
  ...
  def setContaminationError(value: Double): this.type =
    set(contaminationError, value)
  final def getContaminationError: Double = $(contaminationError)

  final val randomSeed = new LongParam(
    this,
    "randomSeed",
  ...
  final val featuresCol =
    new Param[String](this, "featuresCol", "The feature vector.")
  def setFeaturesCol(value: String): this.type = set(featuresCol, value)
  final def getFeaturesCol: String = $(featuresCol)

  final val predictionCol =
    new Param[String](this, "predictionCol", "The predicted label.")
